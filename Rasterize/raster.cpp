...
void scene1() {
    ...
    for (unsigned int i = 0; i < 20; i += 4) {
        ...
        m = new Mesh(Cube);
        m->world = matrix::makeTranslation(-2.0f, 0.0f, (-3 * static_cast<float>(i + 1))) * makeRandomRotation();
        scene.emplace_back(m);
        m = new Mesh(Cube);
        m->world = matrix::makeTranslation(2.0f, 0.0f, (-3 * static_cast<float>(i + 1))) * makeRandomRotation();
        scene.emplace_back(m);
        ...
        m = new Mesh(Cube);
        m->world = matrix::makeTranslation(-2.0f, 0.0f, (-3 * static_cast<float>(i + 2))) * makeRandomRotation();
        scene.emplace_back(m);
        m = new Mesh(Cube);
        m->world = matrix::makeTranslation(2.0f, 0.0f, (-3 * static_cast<float>(i + 2))) * makeRandomRotation();
        scene.emplace_back(m);
        ...
        m = new Mesh(Cube);
        m->world = matrix::makeTranslation(-2.0f, 0.0f, (-3 * static_cast<float>(i + 3))) * makeRandomRotation();
        scene.emplace_back(m);
        m = new Mesh(Cube);
        m->world = matrix::makeTranslation(2.0f, 0.0f, (-3 * static_cast<float>(i + 3))) * makeRandomRotation();
        scene.emplace_back(m);
